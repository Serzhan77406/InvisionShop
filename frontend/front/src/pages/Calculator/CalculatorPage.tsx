        ...
        {result && (
          <div className="calc-results-panel">
            ...
            <div className="calc-warning-notice">
              ℹ️ <strong>Расчёт предварительный.Также проектировщик может основыватся на сборник цен на проектные работы СЦПРК</strong> Точная стоимость — после осмотра инженером.
            </div>
